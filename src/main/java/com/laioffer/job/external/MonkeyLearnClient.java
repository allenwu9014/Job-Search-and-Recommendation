...
public class MonkeyLearnClient {
    ...
    private static final String AUTH_TOKEN = "fadcb1ae3c05ff448ca60bf76df7a7c50c0c38ba";

    public List<Set<String>> extract(List<String> articles) {

        StringBuilder reBuilJsonBuild;
...
//            jsonBody = reBuilJsonBuild.toString();
        ...
        try {
            request.setEntity(new StringEntity(jsonBody, ContentType.DEFAULT_TEXT));
    ...
    public static void main(String[] args) {
       ...
       // System.out.println(GitHubClient.temItemsList.toArray());
